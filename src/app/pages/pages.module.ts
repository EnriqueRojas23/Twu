...
import { ChartModule, DialogModule } from 'primeng';
...
import { AsignarEstibaComponent } from './guia/detallesguia/modal.asignarerrores';
...
@NgModule({
  declarations: [
    ...
    RegistroguiacabeceraComponent,
    GuiaspendientesComponent,
    DetallesguiaComponent,
