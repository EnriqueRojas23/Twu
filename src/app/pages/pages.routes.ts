import { DetallesguiaComponent } from './guia/detallesguia/detallesguia.component';
import { GuiaspendientesComponent } from './guia/guiaspendientes/guiaspendientes.component';
import { RegistroguiacabeceraComponent } from './guia/registroguiacabecera/registroguiacabecera.component';
...
const pagesRoutes: Routes = [
  ...
  //  {path : 'recibo/listaordenrecibo', component : ListaordenreciboComponent, canActivate: [AuthGuard]} ,
    ...
    {path : 'guia/registroguiacabecera', component : RegistroguiacabeceraComponent, canActivate: [AuthGuard]} ,
    {path : 'guia/guiaspendientes', component : GuiaspendientesComponent, canActivate: [AuthGuard]} ,
    {path : 'guia/detallesguia/:uid', component : DetallesguiaComponent, canActivate: [AuthGuard]} ,
